        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Currencies_Currency",
                        column: x => x.Currency,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FromAccID = table.Column<int>(type: "int", nullable: false),
                    ToAccID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_FromAccID",
                        column: x => x.FromAccID,
                        principalTable: "Accounts",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_ToAccID",
                        column: x => x.ToAccID,
                        principalTable: "Accounts",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FromAccID",
                table: "Transactions",
                column: "FromAccID");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ToAccID",
                table: "Transactions",
                column: "ToAccID");
        }
